    ...
    <section id="portfolio">
      <div className= "container">
        <section className="project 1">
          ...
          <div className="demo">
            <p><span className="demo-credentials">Demo Email:</span> wind.chime.app@gmail.com </p>
            <p><span className="demo-credentials">Demo Password:</span> windchime123</p>
          </div>
        ...
        <div className="thumbnail">
          <a href="https://jobreelapp.erincdustin.now.sh" rel="noopener noreferrer" target="_blank"><img src={jobreel} alt="JobReel app" className="portfolio" /></a>
          </div>
          <div className="info">
          <h1>JobReel</h1>
          <img src={react} alt="react symbol" className="stack"/>
          ...
          <div className="demo">
              ...
              <p><span className="demo-credentials">Demo Password:</span> Asdf123!</p>
          </div>
          <a href="https://jobreelapp.erincdustin.now.sh" className="link-text" rel="noopener noreferrer" target="_blank"><button type="click">Demo</button></a>
          <a href="https://github.com/erincdustin/JobReel-client" className="link-text" rel="noopener noreferrer" target="_blank"><button type="click">Client</button></a>
        ...
        <section className="project 3">
          ...
          <div className="info">
            ...
            <div className="demo">
              <p><span className="demo-credentials">Demo Username:</span> demo </p>
              <p><span className="demo-credentials">Demo Password:</span> Passw0rd!</p>
            </div>
