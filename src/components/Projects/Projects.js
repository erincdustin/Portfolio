  ...
  return (
    <section id="portfolio">
      <div className= "container">
        ...
        <div className="thumbnail">
          <a href="https://erins-noteful-app.now.sh/" rel="noopener noreferrer" target="_blank"><img src={noteful} alt="noteful app" className="portfolio" /></a>
          </div>
          <div className="info">
          <h1>Noteful</h1>
          <img src={react} alt="react symbol" className="stack"/>
          ...
          <a href="https://erins-noteful-app.now.sh/" className="link-text" rel="noopener noreferrer" target="_blank"><button type="click">Demo</button></a>
          <a href="https://github.com/erincdustin/Noteful-Day-3" className="link-text" rel="noopener noreferrer" target="_blank"><button type="click">Client</button></a>
          <a href="https://github.com/erincdustin/noteful-server" className="link-text" rel="noopener noreferrer" target="_blank"><button type="click">Server</button></a>
          </div>
        </section>
      </div>
    </section>
